...
for(const cat of fs.readdirSync("./interactions/commands")) {
  for(const file of fs.readdirSync(`./interactions/commands/${cat}`)) {
    const cmd = await import(`./interactions/commands/${cat}/${file}`)
